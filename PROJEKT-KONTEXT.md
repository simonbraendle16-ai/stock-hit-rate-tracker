# PROJEKT-KONTEXT — Stock Hit Rate Tracker (Nachschlagewerk)

> Diese Datei wird **nicht** automatisch geladen. Sie ist der Volltext hinter der Kurzfassung
> in `CLAUDE.md`: alle Domänen-Begriffe je Etappe, die Begründungen dahinter und die
> Fallstricke ungekürzt. Gezielt per Grep nachschlagen, nicht komplett lesen.
